...
def _create_provider_for_type(provider_type: str, settings: Settings) -> BaseProvider:
    ...
    _proxy_map = {
        ...
        "groq": _get_proxy_value(settings, "groq_proxy"),
    ...
    if provider_type == "groq":
        ...
        base_url = settings.groq_base_url.strip() or GROQ_BASE_URL
        config = ProviderConfig(
    ...
    logger.error(
        "Unknown provider_type: '{}'. Supported: 'nvidia_nim', 'open_router', 'groq', 'deepseek', 'lmstudio', 'llamacpp'",
        provider_type,
    )
    raise ValueError(
        f"Unknown provider_type: '{provider_type}'. "
        f"Supported: 'nvidia_nim', 'open_router', 'groq', 'deepseek', 'lmstudio', 'llamacpp'"
    )
