...
[![Tested with Pytest](https://img.shields.io/badge/testing-Pytest-00c0ff.svg?style=for-the-badge)](https://github.com/HamzaaAkmal/Claude-Code-for-Dummies/actions/workflows/tests.yml)
[![Type checking: Ty](https://img.shields.io/badge/type%20checking-ty-ffcc00.svg?style=for-the-badge)](https://pypi.org/project/ty/)
[![Code style: Ruff](https://img.shields.io/badge/code%20formatting-ruff-f5a623.svg?style=for-the-badge)](https://github.com/astral-sh/ruff)
[![Logging: Loguru](https://img.shields.io/badge/logging-loguru-4ecdc4.svg?style=for-the-badge)](https://github.com/Delgan/loguru)

A lightweight proxy that routes Claude Code's Anthropic API calls to **NVIDIA NIM** (40 req/min free), **OpenRouter** (hundreds of models), **Groq** (OpenAI-compatible API), **DeepSeek** (direct API), **LM Studio** (fully local), or **llama.cpp** (local with Anthropic endpoints).
...
| **6 Providers**            | NVIDIA NIM, OpenRouter, Groq, DeepSeek, LM Studio (local), llama.cpp (`llama-server`)            |
...
<details>
<summary><b>Groq</b> (OpenAI-compatible API)</summary>
...
MODEL_SONNET="groq/meta-llama/llama-4-scout-17b-16e-instruct"
MODEL_HAIKU="groq/groq/compound"
...
```bash
uv tool install git+https://github.com/HamzaaAkmal/Claude-Code-for-Dummies.git
...
| **Groq**       | Usage-based  | Varies     | Low-latency OpenAI-compatible models   |
...
Browse: [console.groq.com/models](https://console.groq.com/models)
...
uv tool install "free-claude-code[voice_local] @ git+https://github.com/HamzaaAkmal/Claude-Code-for-Dummies.git"
uv tool install "free-claude-code[voice] @ git+https://github.com/HamzaaAkmal/Claude-Code-for-Dummies.git"
uv tool install "free-claude-code[voice,voice_local] @ git+https://github.com/HamzaaAkmal/Claude-Code-for-Dummies.git"
```
...
| `GROQ_PROXY`         | Optional proxy URL for Groq requests (`http://...` or `socks5://...`) | `""` |
...
├── providers/             # BaseProvider, OpenAICompatibleProvider, NIM, OpenRouter, Groq, DeepSeek, LM Studio, llamacpp
...
- Report bugs or suggest features via [Issues](https://github.com/HamzaaAkmal/Claude-Code-for-Dummies/issues)
